...
sys.path.insert(1, '/focus/utils/') # set the correct path to the dir
...
for iteration in range(num_iterations):
    ...
    del user_train_X, user_train_y, system_train_X, system_train_y
    del user_test_X, user_test_y, system_test_X, system_test_y
    del user_valid_X, user_valid_y, system_valid_X, system_valid_y
    del user_classif, system_classif
